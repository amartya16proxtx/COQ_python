...
Definition t (A: Type) := A * LitSet.t.
...
Fixpoint eval_and_list' {A: Type} (l: list (t A)) : bool :=
  match l with
  | nil => true
  | cons h t => andb (fst h) (eval_and_list' t)
  end.
...
Theorem eval_and_list_rev : forall {A: Type} (l: list (t A)), eval_and_list' (rev l) <-> eval_and_list' l.
Proof.
  induction l; simpl.
  - tauto.
